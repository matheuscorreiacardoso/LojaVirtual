...
namespace LojaVirtual.Data
{
    public class SeedingService
    {
        ...
        public SeedingService(LojaVirtualContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Seller s4 = new Seller(4, "Marta Red", "marta@gmail.com", new DateTime(1998, 11, 30), 3000.0, d4);
            Seller s5 = new Seller(5, "Donald Vlue", "donald@gmail.com", new DateTime(1998, 1, 9), 4000.0, d3);
            Seller s6 = new Seller(6, "Jofrei Black", "jofrei@gmail.com", new DateTime(1998, 3, 4), 3000.0, d2);
